...
for hemi in {L,R}; do
    ...
    mris_convert --annot $OUTPUT_FOLDER/labels/${hemi}.${LABEL_IN}.annot $COCO_PATH/scripts/data/spheres/S1200.${hemi}.sphere.32k_fs_LR.surf.gii $OUTPUT_FOLDER/labels/${hemi}_${LABEL_IN}.label.gii

    ### Project to fsaverage 
    wb_command -label-resample $OUTPUT_FOLDER/labels/${hemi}_${LABEL_IN}.label.gii $COCO_PATH/scripts/data/spheres/S1200.${hemi}.sphere.32k_fs_LR.surf.gii $COCO_PATH/scripts/data/spheres/fs_${hemi}-to-fs_LR_fsaverage.${hemi}_LR.spherical_std.164k_fs_${hemi}.surf.gii BARYCENTRIC $OUTPUT_FOLDER/labels/${hemi}_${LABEL_IN}_fsaverage.label.gii
